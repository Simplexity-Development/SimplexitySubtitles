...
{
    public const string ProjectName = "Subtitles";
...
public sealed class PackageTask : FrostingTask<BuildContext>
{
    public override void Run(BuildContext context)
    {
        ...
        files.Add("modinfo.json");
        files.Add("Subtitles.dll");
        files.Add("Subtitles.pdb");
...
//            $"../Releases/{context.Name}");
        ...
        {
            context.CopyFile($"../{BuildContext.ProjectName}/bin/{context.BuildConfiguration}/Mods/mod/publish/{file}",
                $"../Releases/{context.Name}/{file}");
        }
